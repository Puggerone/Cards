...
const SHADOW = [
  ...
  // wake up / get up
  { id:1,   en:"I woke up at seven and could not get back to sleep.",            tag:"phrasal-a2" },
  ...
  // turn on / turn off
  { id:6,   en:"Can you turn on the lights? It is too dark in here.",            tag:"phrasal-a2" },
  ...
  { id:14,  en:"He wanted to give up but his friends pushed him to continue.",   tag:"phrasal-a2" },
  ...
  { id:24,  en:"The plane took off two hours late because of the weather.",      tag:"phrasal-a2" },
  ...
  { id:29,  en:"He picked up Spanish really quickly while living in Madrid.",    tag:"phrasal-a2" },
  { id:30,  en:"Pick up your things and let us get out of here.",                tag:"phrasal-a2" },

  // look after / run out of
  { id:31,  en:"Can you look after my cat while I am away for the weekend?",     tag:"phrasal-a2" },
  { id:32,  en:"She looks after her little brother every afternoon.",            tag:"phrasal-a2" },
  { id:33,  en:"We ran out of coffee so I had to go to the shop.",               tag:"phrasal-a2" },
  { id:34,  en:"My phone ran out of battery in the middle of the day.",          tag:"phrasal-a2" },
  { id:35,  en:"We are running out of time, we need to hurry up.",               tag:"phrasal-a2" },

  // calm down / cheer up
  { id:36,  en:"Calm down, everything is going to be fine.",                     tag:"phrasal-a2" },
  { id:37,  en:"She told him to calm down and explain what happened.",           tag:"phrasal-a2" },
  ...
  // fill in / put off
  { id:41,  en:"Can you fill in this form with your personal details?",          tag:"phrasal-a2" },
  { id:42,  en:"Fill in the blanks with the correct form of the verb.",          tag:"phrasal-a2" },
  { id:43,  en:"Stop putting things off and just do it.",                        tag:"phrasal-a2" },
  { id:44,  en:"We had to put off the meeting because of the bad weather.",      tag:"phrasal-a2" },
  { id:45,  en:"She kept putting off calling him back.",                         tag:"phrasal-a2" },

  // grow up / slow down
  { id:46,  en:"I grew up in a small town but I always wanted to live in a city.",tag:"phrasal-a2" },
  ...
  { id:50,  en:"He grew up without a father and it was really tough.",           tag:"phrasal-a2" },
  ...
  { id:53,  en:"She finally figured out what she wanted to do with her life.",   tag:"phrasal-b1" },
  { id:54,  en:"I have been trying to figure out where I know him from.",        tag:"phrasal-b1" },
  ...
  // end up
  { id:61,  en:"We got lost and ended up on the wrong side of the city.",        tag:"phrasal-b1" },
  ...
  { id:65,  en:"He always ends up apologizing even when it is not his fault.",   tag:"phrasal-b1" },

  // get along / get on with
  { id:66,  en:"Do you get along with your roommate?",                           tag:"phrasal-b1" },
  { id:67,  en:"We did not get along at first but now we are best friends.",     tag:"phrasal-b1" },
  ...
  { id:70,  en:"They get along fine as long as they do not talk about money.",   tag:"phrasal-b1" },

  // let down
  { id:71,  en:"He really let me down when I needed him most.",                  tag:"phrasal-b1" },
  { id:72,  en:"I do not want to let you down, so I will do my best.",           tag:"phrasal-b1" },
  ...
  // sort out
  { id:76,  en:"I need to sort out my finances before the end of the month.",    tag:"phrasal-b1" },
  ...
  { id:85,  en:"She looked up the word because she did not know what it meant.", tag:"phrasal-b1" },
  ...
  { id:89,  en:"She set up the whole event by herself in just two days.",        tag:"phrasal-b1" },
  ...
  { id:97,  en:"He broke up with her over a text message, which was awful.",     tag:"phrasal-b1" },
  ...
  { id:100, en:"They broke up and made up so many times I lost count.",          tag:"phrasal-b1" },

  // hang out / hang up
  { id:101, en:"We used to hang out every weekend when we were teenagers.",      tag:"phrasal-b1" },
  ...
  { id:104, en:"Do not hang up! I need to tell you something important.",        tag:"phrasal-b1" },
  ...
  { id:107, en:"She dropped by without calling and we were not even home.",      tag:"phrasal-b1" },
  { id:108, en:"We checked in to the hotel and went straight to the pool.",      tag:"phrasal-b1" },
  { id:109, en:"Check in online the night before to save time at the airport.",  tag:"phrasal-b1" },
  ...
  { id:114, en:"It all worked out in the end, which was a relief.",              tag:"phrasal-b1" },
  { id:115, en:"We need to work out a solution that works for everyone.",        tag:"phrasal-b1" },

  // come down with / sign up
  { id:116, en:"I think I am coming down with something, I feel terrible.",      tag:"phrasal-b1" },
  { id:117, en:"She came down with a cold the day before her presentation.",     tag:"phrasal-b1" },
  { id:118, en:"Sign up for the newsletter to get the latest updates.",          tag:"phrasal-b1" },
  { id:119, en:"I signed up for a yoga class and I love it.",                    tag:"phrasal-b1" },
  { id:120, en:"He signed up without even reading the terms and conditions.",    tag:"phrasal-b1" },
  ...
  // go off / break down
  { id:126, en:"My alarm went off and I just turned it off and went back to sleep.", tag:"phrasal-b1" },
  { id:127, en:"The fire alarm went off in the middle of the night.",            tag:"phrasal-b1" },
  { id:128, en:"My car broke down on the motorway and I had to call for help.",  tag:"phrasal-b1" },
  ...
  // get rid of / bring up
  { id:136, en:"It is time to get rid of all the things you do not need.",       tag:"phrasal-b1" },
  { id:137, en:"I cannot get rid of this headache no matter what I do.",         tag:"phrasal-b1" },
  { id:138, en:"She was brought up by her grandparents in the south of Italy.",  tag:"phrasal-b1" },
  ...
  { id:142, en:"It is hard to keep in touch with people after you move away.",   tag:"phrasal-b1" },
  ...
  { id:145, en:"She needs to chill out and stop worrying about everything.",     tag:"phrasal-b1" },
  ...
  { id:148, en:"He passed out from the heat and had to be taken to hospital.",   tag:"phrasal-b1" },
  ...
  { id:157, en:"They carried out the plan exactly as they had discussed.",       tag:"phrasal-b2" },
  { id:158, en:"The doctor told him to cut out sugar and alcohol completely.",   tag:"phrasal-b2" },
  { id:159, en:"Cut it out! I am trying to concentrate.",                        tag:"phrasal-b2" },
  { id:160, en:"She cut out all the stress from her life and felt much better.", tag:"phrasal-b2" },

  // come up / come out
  { id:161, en:"Something came up and I could not make it to the meeting.",      tag:"phrasal-b2" },
  { id:162, en:"A problem came up that nobody had expected.",                    tag:"phrasal-b2" },
  { id:163, en:"The new season comes out next month and I cannot wait.",         tag:"phrasal-b2" },
  ...
  { id:168, en:"We need to deal with this problem before it gets worse.",        tag:"phrasal-b2" },
  { id:169, en:"He deals with complaints every single day and never complains.", tag:"phrasal-b2" },
  ...
  { id:173, en:"He refused to back down even when everyone disagreed with him.", tag:"phrasal-b2" },
  { id:174, en:"She backed down once she realised she was wrong.",               tag:"phrasal-b2" },
  { id:175, en:"Tension had been building up for weeks before it finally exploded.", tag:"phrasal-b2" },

  // cope with / get through
  { id:176, en:"She is finding it hard to cope with everything at the moment.",  tag:"phrasal-b2" },
  ...
  { id:179, en:"I do not know how she gets through the day with so little sleep.",tag:"phrasal-b2" },
  { id:180, en:"He coped with the loss better than anyone expected.",            tag:"phrasal-b2" },

  // hold up / turn down
  { id:181, en:"I was held up in traffic and missed the whole first half.",      tag:"phrasal-b2" },
  { id:182, en:"What is holding you up? We have been waiting for an hour.",      tag:"phrasal-b2" },
  { id:183, en:"She turned down the job offer because the salary was too low.",  tag:"phrasal-b2" },
  ...
  { id:190, en:"He kept on making the same mistake no matter how many times she corrected him.", tag:"phrasal-b2" },
  ...
  { id:194, en:"She found it impossible to let go of what had happened.",        tag:"phrasal-b2" },
  { id:195, en:"He looks up to his father more than anyone else in the world.",  tag:"phrasal-b2" },
  ...
  { id:199, en:"Things will speed up once we have more people on the team.",     tag:"phrasal-b2" },
  ...
  { id:202, en:"Panic broke out when the alarm went off in the building.",       tag:"phrasal-b2" },
  { id:203, en:"Someone broke in while we were away and took the laptop.",       tag:"phrasal-b2" },
  { id:204, en:"She broke in and interrupted him right in the middle of his sentence.", tag:"phrasal-b2" },
  ...
  { id:210, en:"He logged out and handed the laptop back to the receptionist.",  tag:"phrasal-b2" },

  // look into / figure out (B2 context)
  { id:211, en:"The company is looking into ways to reduce its carbon footprint.",tag:"phrasal-b2" },
  { id:212, en:"We are looking into the possibility of expanding abroad.",       tag:"phrasal-b2" },
  { id:213, en:"Scientists are still trying to figure out what caused the outbreak.", tag:"phrasal-b2" },
  { id:214, en:"I finally figured out what had been bothering me all along.",    tag:"phrasal-b2" },
  { id:215, en:"The police are looking into the matter very carefully.",         tag:"phrasal-b2" },

  // make up (B2 nuances)
  { id:216, en:"She made up a completely believable excuse and nobody noticed.", tag:"phrasal-b2" },
  ...
  { id:222, en:"She ended up in a completely different career than she planned.", tag:"phrasal-b2" },
  ...
  { id:227, en:"The government set up a committee to investigate the issue.",    tag:"phrasal-b2" },
  { id:228, en:"She set up an automatic payment so she never forgets the bill.", tag:"phrasal-b2" },
  { id:229, en:"He felt like someone had set him up.",                           tag:"phrasal-b2" },
  { id:230, en:"They set up a meeting between the two sides to try to reach a deal.", tag:"phrasal-b2" },

  // carry out / deal with (mixed B2)
  { id:231, en:"The operation was carried out successfully by a specialist team.",tag:"phrasal-b2" },
  { id:232, en:"Research was carried out over a period of three years.",         tag:"phrasal-b2" },
  { id:233, en:"The company is struggling to deal with the increase in demand.", tag:"phrasal-b2" },
  ...
  { id:244, en:"He showed up with flowers and I completely forgot I was angry.", tag:"phrasal-b1" },
  ...
  { id:248, en:"Just calm down and tell me what happened from the beginning.",   tag:"phrasal-a2" },
  ...
  { id:252, en:"We stayed in and chilled out because we were too tired to go out.", tag:"phrasal-b1" },
  { id:253, en:"She came back from her trip a completely different person.",     tag:"phrasal-a2" },
  ...
  { id:258, en:"I look up to people who manage to stay positive no matter what.",tag:"phrasal-b2" },
  ...
  { id:265, en:"We set up a group chat and suddenly everyone was talking again.",tag:"phrasal-b1" },
  ...
  { id:268, en:"I cannot figure out why I said yes in the first place.",         tag:"phrasal-b1" },
  { id:269, en:"He gave up meat and lost five kilos without even trying.",       tag:"phrasal-a2" },
  { id:270, en:"She ended up loving the city she had always said she hated.",    tag:"phrasal-b1" },
  ...
  { id:278, en:"He went for the promotion even though he was not sure he was ready.", tag:"phrasal-b1" },
  { id:279, en:"She took over and suddenly everything started running smoothly.", tag:"phrasal-b2" },
  { id:280, en:"I woke up with a feeling that today was going to be different.", tag:"phrasal-a2" },
  { id:281, en:"He turned up to every single practice without being asked.",     tag:"phrasal-b1" },
  { id:282, en:"She looked into it and found out it was cheaper than expected.", tag:"phrasal-b2" },
  { id:283, en:"I do not want to end up regretting the chances I did not take.", tag:"phrasal-b2" },
  { id:284, en:"He came up with an idea that changed everything.",               tag:"phrasal-b2" },
  { id:285, en:"She backed down once she realised she had been wrong all along.",tag:"phrasal-b2" },
  ...
  { id:291, en:"She figured out the answer just before the time ran out.",       tag:"phrasal-b1" },
  ...
  { id:294, en:"She held up the queue for ten minutes looking for her card.",    tag:"phrasal-b2" },
  { id:295, en:"He kept on asking until she finally said yes.",                  tag:"phrasal-b2" },
  { id:296, en:"I cannot put up with bad service. I always say something.",      tag:"phrasal-b1" },
  ...
  { id:299, en:"She came down with something the night before the big day.",     tag:"phrasal-b1" },
  { id:300, en:"I am going to give this everything I have got and see what happens.", tag:"phrasal-a2" },
